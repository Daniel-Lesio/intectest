...
const TestimonialsComp = ({data}) => {
    ...
    // const [testies,setTesties] = useState(null)
    ...
    return (
        <section id='news'  className='testies' style={{paddingBottom : 196}} >
            <Image        
            ...
            <CarouselWrapper ref={elem}>
                ...
                {slicedData.map(d=>(
                    ...
                    >
                                ...
                                <Paragraph variants={parentVariants}>{d.testimonial}</Paragraph>
...
`
 ...
 `
 const TestCard = styled(motion.article)`
    display: flex;
    position : relative;
    align-items: center;
