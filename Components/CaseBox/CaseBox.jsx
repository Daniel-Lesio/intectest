    ...
    return (
        <div>
            <Section>
                ...
                <Left>
                    <Header1 style={{fontSize : '26px',fontWeight : 500}} >{props.case.name}</Header1>
                    <div style={{lineHeight : '28px'}}><span style={{fontWeight : 500}}>Employer</span> : { props.case.employer } </div>                    
                    <div style={{lineHeight : '28px'}}><span style={{fontWeight : 500}}>Location</span> : { props.case.location } </div>                    
                    <div style={{lineHeight : '28px'}}><span style={{fontWeight : 500}}>Date</span> : { props.case.date } </div>                    
                    <More>
